...
electron__WEBPACK_IMPORTED_MODULE_1__.ipcMain.handle('window-action', (_, action) => {
  const target = electron__WEBPACK_IMPORTED_MODULE_1__.BrowserWindow.getFocusedWindow();
  if (!target) return;
  switch (action) {
    case 'close':
      target.close();
