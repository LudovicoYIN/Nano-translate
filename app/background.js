...
electron__WEBPACK_IMPORTED_MODULE_1__.ipcMain.handle('select-file-paths', async () => {
  const result = await electron__WEBPACK_IMPORTED_MODULE_1__.dialog.showOpenDialog({
    properties: ['openFile'],
    filters: [{
      name: 'Documents',
...
electron__WEBPACK_IMPORTED_MODULE_1__.ipcMain.handle('capture-screenshot', async () => {
  return '';
});
})();
